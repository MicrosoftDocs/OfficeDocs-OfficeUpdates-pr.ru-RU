...
> - Номера версий и сборок, выделенные полужирным шрифтом, — самые актуальные для соответствующего канала обновления.
...
|**Год**|**Дата выпуска**|**Канал ежемесячного обновления**|**Semi-annual Channel (Targeted)**|**Канал полугодового обновления**|
|:-----|:-----|:-----|:-----|:-----|
...
> [!NOTE]
> Для получения помощи при возникновении проблем, связанных с использованием Office, рекомендуется опубликовать вопрос на [форуме ответов корпорации Майкрософт](https://answers.microsoft.com/) или в [Техническом сообществе](https://techcommunity.microsoft.com/), либо обратиться в [службу поддержки](https://support.microsoft.com/contactus).
