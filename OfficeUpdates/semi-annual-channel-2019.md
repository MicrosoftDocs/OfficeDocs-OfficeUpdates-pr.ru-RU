...
### <a name="excel-feature-updates"></a>Excel. Обновления функций
 ...
 - **Автосохранение файлов из облака теперь включено по умолчанию.** Это изменение означает, что пользователям не придется беспокоиться о том, что внесенные ими изменения будут потеряны в документах, хранящихся в OneDrive или SharePoint Online. Изменения будут автоматически сохраняться в облаке, и пользователям больше не придется нажимать клавиши CTRL+S или кнопку "Сохранить". Однако им нужно понимать это изменение в поведении, чтобы предотвратить случайное изменение документов. Обратите внимание, что пользователи могут отключить автосохранение, воспользовавшись соответствующим переключателем в верхней части экрана. Мы рекомендуем сообщить пользователям об этом предстоящем изменении и научить их, как лучше всего использовать эту новую функцию в Office 365. [Подробнее об автосохранении](https://support.office.com/article/What-is-AutoSave-6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5) и [Подробнее о том, что ИТ-администраторы должны знать об автосохранении](https://support.office.com/article/what-it-administrators-should-know-about-autosave-88e0f80f-e5ea-441b-9c5a-259f08490ae7)
...
### <a name="powerpoint-feature-updates"></a>PowerPoint. Обновления функций 
- **Автосохранение файлов из облака теперь включено по умолчанию.** Это изменение означает, что пользователям не придется беспокоиться о том, что внесенные ими изменения будут потеряны в документах, хранящихся в OneDrive или SharePoint Online. Изменения будут автоматически сохраняться в облаке, и пользователям больше не придется нажимать клавиши CTRL+S или кнопку "Сохранить". Однако им нужно понимать это изменение в поведении, чтобы предотвратить случайное изменение презентаций. Обратите внимание, что пользователи могут отключить автосохранение, воспользовавшись соответствующим переключателем в верхней части экрана. Мы рекомендуем сообщить пользователям об этом предстоящем изменении и научить их, как лучше всего использовать эту новую функцию в Office 365. [Подробнее об автосохранении](https://support.office.com/article/What-is-AutoSave-6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5) и [Подробнее о том, что ИТ-администраторы должны знать об автосохранении](https://support.office.com/article/what-it-administrators-should-know-about-autosave-88e0f80f-e5ea-441b-9c5a-259f08490ae7)
- **Улучшено редактирование ячеек и строк формул.** Теперь вы можете использовать клавиши CTRL+A для выделения текста в ячейке или строке формул. Также улучшена поддержка эмодзи и других сложных символов. [Подробнее](https://support.office.com/article/1798d9d5-842a-42b8-9c99-9b7213f0040f)
