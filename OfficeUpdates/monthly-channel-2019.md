...
- **Добавление заголовков слайдов для создания презентаций с поддержкой специальных возможностей.** Средство проверки читаемости помогает находить и исправлять отсутствующие заголовки слайдов.
