...
### <a name="access-feature-updates"></a>Access. Обновления функций
 - **Обновление, повторное связывание или удаление связанных таблиц.** Обновленный диспетчер связанных таблиц — это место для управления всеми источниками данных и связанными таблицами. [Дополнительная информация](https://support.office.com/article/1d9346d6-953d-4f85-a9ce-4caec2262797)

### <a name="outlook-feature-updates"></a>Outlook. Обновления функций
 - **Отключение пересылки собрания.** Предотвращение пересылки вашего собрания его участниками другим пользователям. Просто перейдите на ленте и щелкните "Параметры ответа". [Дополнительная информация](https://support.office.com/article/5C9877BC-AB91-4A7C-99FB-B0B68D7EA94F)
...
### <a name="visio-feature-updates"></a>Visio. Обновления функций
 ...
 - **Создание документа Word из фигур Visio.** Автоматически добавляйте содержимое диаграмм, включая фигуры и метаданные, в документ Word. Настраивайте документ для создания описаний процессов и руководств по эксплуатации. [Дополнительная информация](https://support.office.com/article/48073f4f-c6d4-4cc0-b9ae-3cb65e2ee158)
 - **Visio и Power BI: лучше вместе.** Всего в несколько щелчков превратите диаграмму Visio в интерактивную визуализацию Power BI. [Дополнительная информация](https://support.office.com/article/4f09be62-f436-45c2-93b0-4a0f66b1f5a7)

 ### <a name="project-feature-updates"></a>Project. Обновления функций
 - **Вы сможете увидеть больше с карточками доске задач.** Если заголовки сами по себе ни о чем не говорят, настройте карточки доски задач, чтобы представить наиболее важные детали. [Дополнительная информация](https://support.office.com/article/1b9b44d7-fd8e-4b3b-ab94-2b97deb9945b)
...
### <a name="excel-feature-updates"></a>Excel. Обновления функций
 - **Улучшенные ячейки и строке редактирования формулы:** Теперь можно использовать сочетание клавиш CTRL + A для выбора текста в ячейке или строке формул. Также улучшена поддержка эмодзи и других сложных знаков.[Дополнительные сведения](https://support.office.com/article/1798d9d5-842a-42b8-9c99-9b7213f0040f)
 - **Улучшена поддержка SVG.** Вы можете вставлять SVG, к которым применены фильтры. [Дополнительные сведения](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)
...
### <a name="outlook-feature-updates"></a>Outlook. Обновления функций
 ...
 - **Улучшения проверки специальных возможностей.** Для проверки специальных возможностей изменены условия поддержки международных стандартов и рекомендаций, чтобы улучшить доступность ваших сообщений. [Дополнительная информация](https://support.office.com/article/a16f6de0-2f39-4a2b-8bd8-5ad801426c7f)
