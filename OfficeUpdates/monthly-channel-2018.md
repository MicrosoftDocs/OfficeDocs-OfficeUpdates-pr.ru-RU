...
### <a name="outlook-feature-updates"></a>Outlook: Обновления компонентов
- **Предупреждения надстроек Outlook:** иногда  могут возникать проблемы в надстройках COM для Outlook, замедляющие работу всего приложения Outlook. Эти проблемы могут быть вызваны задержкой таких событий, как переключение между папками Outlook, доставка новых сообщений, открытие элементов календаря и т. д. При возникновении таких проблем Outlook выводит предупреждение на панели уведомлений.
- **Присоединение к собраниям Teams из диалогового окна "Напоминания" в Outlook.** Когда Outlook напоминает пользователям о предстоящем собрании, в окне отображается кнопка "Подключиться к собранию по сети", если предстоящее собрание представляет собой собрание по сети Teams. Это аналогично присоединению к собранию Skype для бизнеса из диалогового окна "Напоминания" в Outlook.
...
### <a name="visio-feature-updates"></a>Visio: Обновления компонентов
 - **Создание документа Word из фигур Visio:** автоматически добавляйте содержимое схем, включая фигуры и метаданные, в документ Word. Затем настраивайте документ для создания описаний процессов и руководств по эксплуатации. [Подробнее](https://support.office.com/article/48073f4f-c6d4-4cc0-b9ae-3cb65e2ee158)

### <a name="word-feature-updates"></a>Word: Обновления компонентов
 - **Отслеживание исправлений в документах, защищенных с помощью IRM:** теперь вы можете использовать функцию Track Changes в Word в документах, защищенных с помощью IRM, не запрашивая права на полный доступ.
...
### <a name="outlook-feature-updates"></a>Outlook: Обновления компонентов
 ...
 - **Улучшения проверки специальных возможностей.** Для проверки специальных возможностей изменены условия поддержки международных стандартов и рекомендаций, чтобы улучшить доступность ваших сообщений. [Подробнее](https://support.office.com/article/a16f6de0-2f39-4a2b-8bd8-5ad801426c7f)
...
### <a name="project-feature-updates"></a>Project: Обновления компонентов
 - **Организуйте места последнего сохранения:** в Project ведется список мест сохранения других проектов. Когда вы будете готовы сохранить свой проект, просто выберите одно из последних мест сохранения.
...
### <a name="visio-feature-updates"></a>Visio: Обновления компонентов
 - **Больше наборов элементов, больше значков, больше выбора.** Мы добавили 26 наборов элементов, в том числе "Аналитика", "Искусство", "Праздник", "Лица", "Расположение", "Медицина", "Природа", "Люди", "Спорт", "Погода и времена года" и другие.
...
### <a name="outlook-non-security-updates"></a>Outlook: Обновления, не связанные с безопасностью
 - Исправьте ошибку, из-за которой вызов API MAPI из приложения может привести к сбою.
...
### <a name="outlook-non-security-updates"></a>Outlook: Обновления, не связанные с безопасностью
 - Исправьте ошибку, из-за которой Outlook дает сбой при использовании надстройки iCloud.
...
### <a name="skype-for-business-non-security-updates"></a>Skype для бизнеса: Обновления, не связанные с безопасностью
-   Исправьте ошибку, из-за которой расположение указывается, даже если для параметра UseLocationForE911Only задано значение true.
...
### <a name="visio-feature-updates"></a>Visio: Обновления компонентов
-   **Использование  Visio диаграммы Excel для экспорта в схему Visio:** быстро переходите к блок-схемам Visio. Введите данные в одном из шаблонов карты процесса в Excel и экспортируйте их в Visio для автоматического создания схемы. Требуется Visio Pro для Office 365.
...
### <a name="excel-non-security-updates"></a>Excel: Обновления, не связанные с безопасностью
-   Исправьте ошибку, из-за которой программное создание и последующее программное обновление сводной таблицы приводило к сбою Excel.
-   Исправьте ошибку, возникающую при программном вызове Workbook.Open() и приводящую к сбою Excel.
