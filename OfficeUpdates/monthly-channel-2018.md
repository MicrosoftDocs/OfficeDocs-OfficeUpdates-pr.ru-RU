...
> - Мы часто выпускаем функции (а иногда даже исправления) для Monthly Channel по истечении определенного времени. Это позволяет убедиться в том, что все прекрасно работает, прежде чем выпускать функцию для широкого доступа. Если вы не видите чего-либо из описанного ниже, не беспокойтесь, вы получите это позже. 
  [Подробнее](https://support.office.com/en-us/article/when-do-i-get-the-newest-features-in-for-office-365-da36192c-58b9-4bc9-8d51-bb6eed468516?ui=en-US&rs=en-US&ad=US)

## <a name="version-1810-october-29"></a>Версия 1810 за 29 октября
...
- **Легкое редактирование в строке формул.** Теперь вы с помощью клавиш CTRL+A можете выделить текст в ячейке или строке формул. Кроме того, расширена поддержка эмодзи и других сложных символов. [Подробнее](https://support.office.com/article/402d8c2a-354c-4690-bacf-1c319c4ec2fb)

### <a name="outlook-feature-updates"></a>Outlook. Обновления функций 

- **Предложения, касающиеся пользователей, в помощнике по планированию.** Просматривайте рекомендации в отношении того, каких участников добавлять, при планировании собрания. Вам больше не нужно будет открывать поочередно помощник по планированию и строку "Кому". [Подробнее](https://support.office.com/article/d284c6d9-206e-4926-92b4-5addc0fcbefb)
- **Более простое резервирование комнаты.** Ищите конференц-зал в нескольких списках комнат. При этом можно поочередно открывать списки, не теряя выбранные комнаты.
...
- **Добавление живых красок в документы.** Вставляйте на страницы анимированные 3D-рисунки, на которых показаны орбиты планет, бьющееся сердце, неистовствующий тираннозавр. [Подробнее](https://support.office.com/article/ad6ade3a-be41-4cf1-b761-46dcfd14dfc8)
...
## <a name="version-1809-october-16"></a>Версия 1809 за 16 октября
...
## <a name="version-1809-october-9"></a>Версия 1809 за 9 октября
...
## <a name="version-1809-september-27"></a>Версия 1809 за 27 сентября
...
### <a name="powerpoint-feature-updates"></a>PowerPoint: обновления функций
- **Добавление живых красок на слайды.** Вставляйте на экран анимированные 3D-рисунки, на которых показаны орбиты планет, бьющееся сердце, неистовствующий тираннозавр.  [Подробнее](https://support.office.com/article/ad6ade3a-be41-4cf1-b761-46dcfd14dfc8)
- **Новый вид значков на ленте.** Не волнуйтесь, ведь все работает точно так же. Кроме того, они великолепно смотрятся на экране любого размера. [Подробнее](https://support.office.com/article/c6bc4cd8-d151-41d3-8276-fc7c9975eb79)
...
## <a name="version-1808-september-11"></a>Версия 1808 за 11 сентября
...
## <a name="version-1808-september-5"></a>Версия 1808 за 5 сентября
...
### <a name="visio-feature-updates"></a>Visio: обновления функций
 ...
 - **Создание документа Word на основе фигур Visio.** Обеспечьте автоматическое добавление содержимого схем, в том числе фигур и метаданных, в документ Word. Затем настройте документ для создания руководств по обработке и использованию. [Подробнее](https://support.office.com/article/48073f4f-c6d4-4cc0-b9ae-3cb65e2ee158)
...
## <a name="version-1807-august-14"></a>Версия 1807 за 14 августа
...
## <a name="version-1806-july-17"></a>Версия 1806 за 17 июля
...
### <a name="excel-feature-updates"></a>Excel. Обновления функций
 - **Улучшенное редактирование в ячейках и строке формул.** Теперь вы с помощью клавиш CTRL+A можете выделить текст в ячейке или строке формул. Кроме того, расширена поддержка эмодзи и других сложных символов. [Дополнительные сведения](https://support.office.com/article/1798d9d5-842a-42b8-9c99-9b7213f0040f)
...
### <a name="excel-feature-updates"></a>Excel. Обновления функций
 - **Общение с соавторами во время редактирования.** Сотрудничайте эффективнее благодаря возможности общаться в чате с соавторами, не выходя из приложения Excel. Обратите внимание на то, что эта функция не доступна в некоторых регионах. [Дополнительные сведения](https://support.office.com/article/1ecc6c7f-0b02-4baa-b9d9-c9d67023bedd)
...
-   **Напоминания, которые невозможно пропустить.** Настройте отображение всплывающих окон с напоминаниями в тех окнах, в которых работаете. Если вы этого не сделаете, значок Outlook будет мигать на панели задач для привлечения вашего внимания. [Дополнительные сведения](https://support.office.com/article/7a992377-ca93-4ddd-a711-851ef3597925)
